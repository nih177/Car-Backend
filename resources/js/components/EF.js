    ...
    return (
        <div id="content">
            ...
            <form method="post" action="carfinance_first.php">
                ...
                <div id="equipmentfinance-body" className="body-content">
                    <div className="row body-text"><div className="eight columns">
                        <h1>Equipment Finance - Business Equipment Lease</h1>
                        <h2>
                            Business Lease Equipment</h2>
                        <p>
                            Our commercial finance team can organise any equipment lease anywhere in Australia. We provide for all financing and leasing options. Fast approval with low interest rates from the banks. We can organise finance on small office equipment leasing to heavy equipment finance. It is important to understand which type of equipment loan to take. If you are unsure just ask us and we will be happy to go through these. Some choices available:</p>
                        <ul>
                            <li>
                                Chattel mortgage,</li>
                            <li>
                                Commercial hire purchase (CHP),</li>
                            <li>
                                Equipment lease,</li>
                            <li>
                                Fully maintained equipment lease,</li>
                            <li>
                                Rentals,</li>
                            <li>
                                Structured repayments.</li>
                        </ul>
                        <h2>
                            Low Doc Loans - Non Conforming</h2>
                        <p>
                            Not up to date with lodging your Financials? No problem; Carloansales has some great low docs equipment finance or non conforming options. New or used equipment and private sales are not a problem at Carloansales. Carloansales can help with all of your equipment financing needs.</p>
                        <h2>
                            Equipment Finance Rates</h2>
                        <p>
                            Carloansales provide the lowest interest rates that are much lower than most banks on all machinery and equipment loans.</p>
                        <h2>
                            Heavy Equipment Finance</h2>
                        <p>
                            Our specialist heavy equipment finance staff have many years experience. We understand financial's, different loans for corporate entity structure, cash flows, forecasts, GST. Anything from a sole trader, partnership, company, trust to a large corporate entity. We deliver the finance required.</p>
                        <h2>
                            Features and benefits of Equipment Finance</h2>
                        <ul>
                            <li>
                        ...
                        <h2>
                            Who can benefit from Equipment Finance, Lease and Commercial Finance Loans?</h2>
                        <p>
                            Any firm, partnership, company and professional or business people who want to acquire plant-equipment, motor vehicles, or similar goods used in the production of assessable income.</p>
                        <h2>
                            Need more Equipment Finance information?</h2>
                        <p>
