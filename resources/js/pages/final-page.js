...
export default function FinalPage(props) {
    ...
    function submitForm(e) {
        ...
        if (VALIDATE_ALPHA(props.repay) == false) {
            document.getElementById("repay-span").style.display = "block";
            validated = 0;
        }
            ...
            <ReactBootstrap.Row className="d-flex align-items-center pl40p5">
                <ReactBootstrap.Row id="page4" className="mx-auto w62 form-container-no-bg">
                    ...
                    <ReactBootstrap.Col md={12} className="mt15 normal-text">
                        How would you like to do the repayment?
                        <br />
                    </ReactBootstrap.Col>
                    ...
                    <ReactBootstrap.Col className="w19 mt4" md={3}>
                        <button onClick={e => { e.preventDefault(); props.setRepay("Fortnight"); updateRepay() }} className="w100 small-button-text">Fortnight</button>
                        <br />
                    </ReactBootstrap.Col>
                    <ReactBootstrap.Col className="w19 mt4" md={3}>
                        <button onClick={e => { e.preventDefault(); props.setRepay("Month"); updateRepay() }} className="w100 small-button-text">Month</button>
                        <br />
                    </ReactBootstrap.Col>
