                                ...
                                <tr>
                                    <td colspan="4">
                                        <div onMouseEnter={() => setIsShown(true)}
                                                onMouseLeave={() => setIsShown(false)} className="tickbox" style={{ height: "30px;" }}>

                                            {isShown && (
                                                <div onMouseEnter={() => setIsShowns(true)}
                                                onMouseLeave={() => setIsShowns(false)} className="privacy-box" >
                                            ...
                                            <p>I accept the above <strong >Privacy Disclosure &amp; Consent</strong> statement"</p>
                                            </div>
                                        </div>
